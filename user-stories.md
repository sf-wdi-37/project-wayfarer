...
4. Use an "Add New Post" button on the San Francisco city page to pull up the new post form.
5. Create a new post for San Francisco.
6. Click "Edit" on ANY individual post, and be redirected to the edit form.
